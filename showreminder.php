...
<head>
	...
	<link rel="stylesheet" href="assets/css/showreminder.css">
	<script src="assets/js/reminder_validation.js"></script>
		...
		<div class="row">
			...
			<article class="col-sm-12 maincontent">
				<header class="page-header">
					<h1 class="page-title">Your Reminders</h1>
				</header>
  ...
  <table class="table table-bordered" style="table-layout: fixed;width:100%;">
    <tbody>
      <tr>
		...
		<div id=all_contacts>All Reminders</div>
		<a id=add_reminder href="showreminder.php?click=add_reminder" name="add_reminder" >add_reminder</a>
		</div>
		</td>
      ...
      <div class="headerLink editContact">
        <ul>
          <li class="action edit" id="edit_reminder" onclick="location.href ='showreminder.php?edit_reminder_update=<?php if(isset($_GET["edit_reminder"]))
			echo $_GET["edit_reminder"];
		?>'">Edit Reminder</li>
          <li class="action single delete active" id="delete_reminder" onclick="location.href ='delete_reminder_update.php?delete_reminder_update=<?php if(isset($_GET["edit_reminder"]))
			echo $_GET["edit_reminder"];
		?>'">Delete Reminder</li>
        </ul>
      </div>
	   ...
	   <tr>
			...
			<div id="group_-1"> 
				<?php
				require_once('fetch_reminder.php');
				?>
	   ...
	   if(isset($_GET['click']))
		...
		elseif(isset($_GET['select_reminder']))
		{
			//echo "<p>".$_GET['select_contact']."</p>";
			require_once('display_reminder.php');
		}
		elseif(isset($_GET['edit_reminder_update']))
		{
			//echo "<p>".$_GET['edit_contact_update']."</p>";
			require_once('edit_reminder.php');
		}
